...
| `ollamaCopilot.agent.enableThinking` | `true` | — | Enable chain-of-thought reasoning. Thinking models think by default (Ollama enables it automatically); this setting is reserved for future use. |
