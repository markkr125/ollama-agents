# Ollama Copilot Documentation

> User-facing guides for installing, configuring, and using the extension.
>
> For **developer/contributor** documentation, see the [copilot instructions](../.github/copilot-instructions.md) and scoped files in `.github/instructions/`.
